...
df_content.nunique(),df_content.shape
...
new_user_recs = new_user_recs = [str(id) for id in get_top_article_ids(10)] 
...
user_item_train.shape, user_item_test.shape, common_idx.sum(), len(test_idx)
...
len(common_idx), user_item_test.shape
